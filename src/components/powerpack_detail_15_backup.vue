...
<br>
    <v-row>
      <v-col>
        <h5 class="font-weight-bold text-center"> S Y S T E M</h5>
        <v-card
      ...
      <v-col>
        <h5 class="font-weight-bold text-center"> S C U</h5>
        <v-card
        border="opacity-50 sm"
        class="mx-auto"
        min-width="500"
      ...
      <v-col>
        <h5 class="font-weight-bold text-center">S P D U</h5>
        <v-card
        border="opacity-50 sm"
        class="mx-auto"
        min-width="400"
...
<v-col>
        ...
        <h5 class="font-weight-bold text-center">C O N V E R T E R</h5>
        <v-card
        border="opacity-50 sm"
        class="mx-auto"
        min-width="400"
      ...
      <v-col>
        ...
        <h5 class="font-weight-bold text-center">M P D U</h5>
        <v-card
        border="opacity-50 sm"
        class="mx-auto"
        min-width="400"
