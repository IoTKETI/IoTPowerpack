<template>
  <div>
    <v-container class="ma-1 pa-10">
    <h3 class="font-weight-bold text-left">10kW 공냉식</h3>
...
<v-toolbar flat>
    ...
    <v-row>
      <v-col>
        <h5 class="font-weight-bold text-left"> &nbsp; SYSTEM</h5>
        <v-data-table
          :headers="System"
          :items="System_detail"
      ...
      <v-col>
        <h5 class="font-weight-bold text-left"> &nbsp; SCU</h5>
        <v-data-table
          :headers="SCU"
          :items="SCU_detail"
          class="elevation-1 font-weight-bold"
      ...
      <v-col>
        <h5 class="font-weight-bold text-left">&nbsp; SPDU</h5>
        <v-data-table
          :headers="SPDU"
          :items="SPDU_detail"
          class="elevation-1 font-weight-bold"
        ...
        <h5 class="font-weight-bold text-left">&nbsp; CONVERTER</h5>
        <v-data-table
          :headers="CONVERTER"
        ...
        <br />
        <h5 class="font-weight-bold text-left">&nbsp; MPDU</h5>
        <v-data-table
          :headers="MPDU"
          :items="MPDU_detail"
          class="elevation-1 font-weight-bold"
