...
export default {
    ...
    data() {
        return {
          ...
          { text: 'ModBus Address', value: 'calories', sortable: false},
          { text: 'ModBus Name', value: 'fat', sortable: false },
          { text: '단위', value: 'carbs', sortable: false },
          { text: 'Min(그래프상)', value: 'protein', sortable: false },
          { text: 'Max(그래프상)', value: 'iron', sortable: false },
          { text: 'Green(Normal)', value: 'iron', sortable: false },
          { text: 'Orange(Warning)', value: 'iron', sortable: false },
          { text: 'Red(Danger)', value: 'iron', sortable: false }
