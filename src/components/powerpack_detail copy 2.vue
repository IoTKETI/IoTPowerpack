<template>
    ...
    <v-container>
      <p class="font-weight-normal text-center">10kW 공냉식 1</p>
      hello

      <v-row>
        <v-col>
          <p class="font-weight-normal text-left">SYSTEM</p>
          <v-data-table
            :headers="System"
            :items="System_detail"
            class="elevation-1"
        ...
        <v-col>
          <p class="font-weight-normal text-left">SCU</p>
          <v-data-table
            :headers="SCU"
            :items="SCU_detail"
            class="elevation-1"
        ...
        <v-col>
          <p class="font-weight-normal text-left">SPDU</p>
          <v-data-table
            :headers="SPDU"
            :items="SPDU_detail"
            class="elevation-1"
          ...
          <p class="font-weight-normal text-left">CONVERTER</p>
          <v-data-table
            :headers="CONVERTER"
          ...
          <br />
          <p class="font-weight-normal text-left">MPDU</p>
          <v-data-table
            :headers="MPDU"
            :items="MPDU_detail"
            class="elevation-1"
