<template>
  ...
  <div id="inspire" class="ma-0 pa-10">
    ...
    <h3 class="font-weight-bold text-center"> :&nbsp;: &nbsp; P O W E R P A C K  &nbsp; M O N I T O R I N G &nbsp; :&nbsp;: &nbsp; 1 5 k W</h3>
<br>
<br>
<br>
    <v-row>
      ...
      <br />
      <v-col>
        <h5 class="font-weight-bold text-center"> I N F O R M A T I O N</h5>
        <v-card
...
<br />
      <v-col>
        <h5 class="font-weight-bold text-center">E L E C T R I C &nbsp;  P O W E R &nbsp; S T A T U S</h5>
        <v-card
        border="opacity-50 sm"
        class="mx-auto"
        min-width="500"
...
<br />
      <v-col>
        <h5 class="font-weight-bold text-center">S E N S O R &nbsp; S T A T U S </h5>
        <v-card
        border="opacity-50 sm"
        class="mx-auto"
        min-width="500"
...
<br />
      <v-col>
        <h5 class="font-weight-bold text-center">B O P &nbsp; S T A T U S</h5>
        <v-card
        border="opacity-50 sm"
        class="mx-auto"
        min-width="500"
...
data() {
  return {
    ...
    SPDU: [
      ...
      { text: "명칭", value: "SPDU1", sortable: false },
      { text: "값", value: "SPDU2", sortable: false },
    ...
    SPDU_detail1: [
      ...
      {
        name: "LDC 출력",
        SPDU1: "ldc_ch1Voltage",
        SPDU2: 12.5,
        UNIT: "Volt.",
      },
      {
        name: "LDC 출력",
        SPDU1: "ldc_ch1Current",
        SPDU2: 12.6,
        UNIT: "Amp.",
      },
      {
      ...
      {
        name: "LDC 출력",
        SPDU1: "ldc_ch2Voltage",
        SPDU2: 24.7,
        UNIT: "Volt.",
      },
      {
        name: "LDC 출력",
        SPDU1: "ldc_ch2Current",
        SPDU2: 24.8,
        UNIT: "Amp.",
      },
      {
    ...
    SPDU_detail2: [
      {
        name: "APS센서 AF201",
        SPDU1: "sens_afsPressure",
        SPDU2: 62.3,
        UNIT: "Kpa",
      },
      {
        name: "APS센서 AF201",
        SPDU1: "sens_afsTemperature",
        SPDU2: 34.5,
        UNIT: "℃",
      },
      {
      ...
      {
        name: "APS센서 201",
        SPDU1: "sens_201Pressure",
        SPDU2: 60.1,
        UNIT: "Kpa",
      },
      {
        name: "APS센서 201",
        SPDU1: "sens_201Temperature",
        SPDU2: 30.2,
        UNIT: "℃",
      },
      {
        name: "APS센서 211",
        SPDU1: "sens_211Pressure",
        SPDU2: 61.3,
        UNIT: "Kpa",
      },
      {
        name: "APS센서 211",
        SPDU1: "sens_211Temperature",
        SPDU2: 61.4,
        UNIT: "℃",
      },
      {
        name: "APS센서 301",
        SPDU1: "sens_301Pressure",
        SPDU2: 751.2,
        UNIT: "Kpa",
      },
      {
        name: "APS센서 301",
        SPDU1: "sens_301Temperature",
        SPDU2: 53.4,
        UNIT: "℃",
      },
      {
        name: "APS센서 302",
        SPDU1: "sens_302Pressure",
        SPDU2: 55.6,
        UNIT: "Kpa",
      },
      {
        name: "APS센서 302",
        SPDU1: "sens_302Temperature",
        SPDU2: 57.8,
        UNIT: "℃",
      },
      {
        name: "APS센서 311",
        SPDU1: "sens_311Pressure",
        SPDU2: 57.9,
        UNIT: "Kpa",
      },
      {
        name: "APS센서 311",
        SPDU1: "sens_311Temperature",
        SPDU2: 58.1,
        UNIT: "℃",
      },
      {
        name: "APS센서 401",
        SPDU1: "sens_401Pressure",
        SPDU2: 51.2,
        UNIT: "Kpa",
      },
      {
        name: "APS센서 401",
        SPDU1: "sens_401Temperature",
        SPDU2: 53.4,
        UNIT: "℃",
      },
      {
        name: "APS센서 411",
        SPDU1: "sens_411Pressure",
        SPDU2: 55.6,
        UNIT: "Kpa",
      },
      {
        name: "APS센서 411",
        SPDU1: "sens_411Temperature",
        SPDU2: 57.8,
        UNIT: "℃",
      },
    ],
    ...
    SPDU_detail3: [
      ...
      {
        name: "CVM",
        SPDU1: "cvm_aveVoltage",
        SPDU2: 650.1,
        UNIT: "mV",
      },
      {
        name: "CVM",
        SPDU1: "cvm_minVoltage",
        SPDU2: 640.2,
        UNIT: "mV",
      },
      {
      ...
      {
        name: "CVM",
        SPDU1: "svm_cell1Voltage",
        SPDU2: 664.5,
        UNIT: "mV",
      },
      {
        name: "CVM",
        SPDU1: "svm_cell150Voltage",
        SPDU2: 640.2,
        UNIT: "mV",
      },
    ],
